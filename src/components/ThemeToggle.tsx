  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        className={
          selected ? "fill-pink-400/20 stroke-pink-500" : "stroke-zinc-400"
        }
      />
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className={selected ? "stroke-pink-500" : "stroke-zinc-400"}
      />
    </svg>
  );
}
